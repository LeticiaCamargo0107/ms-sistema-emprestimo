...
public class UpdateCustomerUseCase {
    ...
    public Customer execute(String id, Customer customer) throws CustomerDocumentNotFoundException, CustomertNotFoundException, CustomerAddressNotFoundException {
